    ...
    <b-tabs>
      <b-tab title="<i class='icon-user'></i>" class="tab-cars-sales">
        ...
        <Callout variant="info" class="m-0 py-3 text-center">
          <div><strong>{{ userLocal.office.officeType.description }}</strong></div>
          <div>{{ userLocal.office.description }}</div>
          <small class="text-muted mr-3"><i class="icon-directions"></i>&nbsp; {{ userLocal.office.address }}</small> <br>
      ...
      <b-tab title="<i class='fa fa-car'></i>" @click="getSalesCart" class="tab-cars-sales">
