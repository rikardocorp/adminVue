<template>
  <div class="upload-file">
    ...
    <form enctype="multipart/form-data" novalidate v-if="isInitial || isSaving">
      <div class="dropbox">
        <input type="file" :multiple="multiple" :name="uploadFieldName" :disabled="isSaving"
               ...
               class="input-file">
        <p v-if="isInitial">
          Arrastra un archivo PDF aquí para comenzar<br> o haz clic para buscar la imagen <br>
          <i class="fa fa-file-text fa-4x pt-3" aria-hidden="true"></i> <br>
          <span class="text-italic">* Se recomienda cargar un archivo menor a 1MB de tamaño</span>
        </p>
        <p v-if="isSaving">
          Cargando una imagen...
        </p>
    ...
    <div v-if="isSuccess">
      <div class="dropbox">
        <p class="message">Se ha cargado el archivo exitosamente.</p>
        <p class="text-center">
          <a href="javascript:void(0)" @click.prevent="reset()">Cargar otra archivo</a>
        </p>
