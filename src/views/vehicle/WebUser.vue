...
<script>
  import {DATA_WEBUSER as nDATA} from '../../data/dataNames'
  import Form from './forms/FormWebUser.vue'
  ...
  export default {
    ...
    data: function () {
      return {
        ...
        // Modal
        modalDetails: { title: 'Eliminar Registro', data: 'Esta seguro de eliminar estooooo?' },
        showModal: false,
        action: '',
        ownClass: ''
      }
