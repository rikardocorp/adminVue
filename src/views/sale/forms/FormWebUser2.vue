  ...
  <b-card>
    ...
    <b-form>
      ...
      <b-form-group
        ...
        :state="null"
        :horizontal="horizontal">
        <b-form-input :disabled="isLoading" type="email" :state="null" v-model.trim="item.email" placeholder="Ingrese su numero telefonico.."></b-form-input>
      </b-form-group>

      <b-card bg-variant="dark"
              text-variant="white"
              variant="dark"
              header="Datos de Seguridad"
              align="left">
        <b-form-group
          label="Username:"
          feedback="feedback"
          :state="null"
          :horizontal="horizontal">
          <b-form-input :disabled="isLoading" :state="null" v-model.trim="item.username" placeholder="Ingrese username.."></b-form-input>
        </b-form-group>
        ...
        <b-form-group
          ...
          :state="null"
          :horizontal="horizontal">
          <b-form-input :disabled="isLoading" type="email" :state="null" v-model.trim="item.password" placeholder="Ingrese un Password.."></b-form-input>
        </b-form-group>
      </b-card>
