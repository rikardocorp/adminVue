    ...
    <b-card>
      <div class="row">
        <div class="col-sm-5">
          ...
          <div class="small text-muted">Octubre 2017</div>
        </div><!--/.col-->
        <div class="col-sm-7 hidden-sm-down">
          ...
          <b-button-toolbar class="float-right" aria-label="Toolbar with button groups">
            <b-button-group class="mr-3" aria-label="First group">
              <b-button variant="outline-secondary">Dia</b-button>
              <b-button variant="outline-secondary" :active="true">Mes</b-button>
              <b-button variant="outline-secondary">Año</b-button>
            </b-button-group>
          </b-button-toolbar>
        </div><!--/.col-->
      </div><!--/.row-->
          ...
          <div class="row">
            <div class="col-sm-12 col-lg-4">
              <div class="row">
                <div class="col-sm-6">
                  <Callout variant="info">
                    <small class="text-muted">Nuevos Clientes</small><br>
              ...
              <ul class="horizontal-bars">
                ...
                <li class="legend">
                  <span class="badge badge-pill badge-info"></span> <small>Nuevos Clientes</small> &nbsp; <span class="badge badge-pill badge-danger"></span> <small>Recurring clients</small>
                </li>
              </ul>
            </div><!--/.col-->
