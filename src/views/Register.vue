          ...
          <div class="card-group mb-0">
            ...
            <div class="card p-4">
              <div v-if="!changePass" class="card-body">
                <h1>JMC</h1>
                <p class="text-muted">Registrarse como usuario</p>
                ...
                <div class="input-group mb-4">
                  <span class="input-group-addon"><i class="icon-lock"></i></span>
                  <input type="number" class="form-control" placeholder="Numero Telefonico" v-model="credentials.phone">
                </div>
                <div class="row">
                  <div class="col-6">
                  ...
                  <div class="col-6 text-right">
                    <router-link class="color-primary" style="text-decoration:underline" tag="a" to="/webpage">Regresar a la web</router-link>
